      ...
      >
        <div className="relative">
          ...
          <main className="sandbox">
            ...
            <Filter selectedFilter={selectedFilter} onFilterClick={handleFilterClick} pageTitle={pageTitle} subCategories={accesoriosSubCategories}>
              {/* Cards ahora recibe la categoría y los productos de tecnología */}
              <Cards selectedFilter={selectedFilter} products={accesoriosProducts} />
            </Filter>
            <Footer />
          </main>
        </div>
